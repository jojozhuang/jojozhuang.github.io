...
image: /public/portfolios/kaixinassistantdotnet/thumbnail.png
...
## 2. Main Screen
![kaixin](/public/portfolios/kaixinassistantdotnet/full.png "kaixin")  
...
![task](/public/portfolios/kaixinassistantdotnet/task.png "task")
## 3.3 Run Task
Right-click on the task and run. During it is running, you can check the logs to see whether it works properly.
![running](/public/portfolios/kaixinassistantdotnet/running.png "running")  
