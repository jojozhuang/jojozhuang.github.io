...
### 2.1 Installing JDK
Refer to [Setting up Java Development Environment on Ubuntu]({% link _devops/basis/setting-up-java-development-environment-on-ubuntu.md %}) to install JDK on Linux.
