...
### 3.1 Node Server
First, follow the steps mentioned in [Creating Http Server with Node.js]({% link _frontend/nodejs/creating-http-server-with-nodejs.md %}) to setup a node server. It is served at post 8086.
![image](/public/images/devops/42/nodeserver.png){:width="700px"}  
### 3.2 Nginx Server
...
![image](/public/images/devops/42/nginxserver.png){:width="700px"}  
...
![image](/public/images/devops/42/proxy.png){:width="700px"}  
### 3.4 More Options
```raw
location /some/path/ {
