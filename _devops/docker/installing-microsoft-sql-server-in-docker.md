...
![image](/public/images/devops/712/dockersearch.png)  
Kitematic will start to download the image and create container for it.
![image](/public/images/devops/712/installing.png)  
...
![image](/public/images/devops/712/containercreated.png)  
...
![image](/public/images/devops/712/env.png)
### 3.3 Interactive Shell
Click the 'EXEC' button to start an interactive shell.
![image](/public/images/devops/712/exec.png)
Now, we are in the bash shell for sql server.
![image](/public/images/devops/712/terminalmssql.png){:width="600px"}  
...
$ docker ps -a
```
![image](/public/images/devops/712/createcontainer.png)  
In Kitematic, we also see a new container.
![image](/public/images/devops/712/containercreated2.png)  
...
```
![image](/public/images/devops/712/terminalmssql2.png){:width="600px"}  
...
GO
```
![image](/public/images/devops/712/createdb.png){:width="600px"}  
...
GO
```
![image](/public/images/devops/712/createtable.png){:width="600px"}  
### 5.4 Querying Data
...
GO
```
![image](/public/images/devops/712/selectdata.png){:width="600px"}  
...
![image](/public/images/devops/712/addjtds.png){:width="800px"}  
...
![image](/public/images/devops/712/createconnection.png){:width="800px"}  
...
![image](/public/images/devops/712/sqldeveloper.png)
### 6.5 Running Query
Right-click on the `TestDB` database, and choose `Select Default Database`.
![image](/public/images/devops/712/defaultdatabase.png){:width="300px"}  
Then, apply.
![image](/public/images/devops/712/apply.png){:width="350px"}  
In the worksheet, input the following sql script and run. You will see all rows in table `Inventory`.
```sql
SELECT * FROM Inventory;
```
![image](/public/images/devops/712/runquery.png)
