...
In the previous posting [Using MySQL Container for JSP Application]({% link _devops/docker/using-mysql-container-for-jsp-application.md %}), we created a MySQL container to store data for our JSP Tutorial application. Previously, we used the following command to create MySQL container.
```sh
...
![image](/public/tutorials/704/dockerfiles.png){:width="600px"}  
...
![image](/public/tutorials/704/imagecreated.png){:width="800px"}  
...
![image](/public/tutorials/704/general.png)  
Port 3306 is also exposed and mapped to 6603.
![image](/public/tutorials/704/ports.png)  
...
![image](/public/tutorials/704/workbench.png)  

### 4.4 Verifying JSP Tutorial Website
In Eclipse, open the JSP Tutorial project which we created for [Using MySQL Container for JSP Application]({% link _devops/docker/using-mysql-container-for-jsp-application.md %}). Run it and access
...
![image](/public/tutorials/704/productlist.png)  
...
$ docker images
```
![image](/public/tutorials/704/newimage.png)  
...
![image](/public/tutorials/704/dockerhub.png)  
