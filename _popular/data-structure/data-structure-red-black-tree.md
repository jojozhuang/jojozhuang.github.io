...
![image](/assets/images/dsa/1123/bst.png){:width="800px"}
...
![image](/assets/images/dsa/1123/red-black-tree.png)
The following examples are **NOT** Red Black Tree.
![image](/assets/images/dsa/1123/not-rbt.png)
### 1.2 Time Complexity
* Search - $O(\log{}n)$
* Insertion - $O(\log{}n)$
* Deletion - $O(\log{}n)$
...
![image](/assets/images/dsa/1123/insertion-special-case.png){:width="700px"}
### 3.2 Non-empty Tree
...
![image](/assets/images/dsa/1123/naming.png){:width="700px"}
If `p` is red, then p now has a red child, which violates the red property. Note that p's parent, `g`, must be black. In order to handle this double-red situation, we will need to consider the color of g's other child, that is, p's sibling, `s`. (Note that s might be null, i.e., g only has one child and that child is p.) We have two cases:
  * **Case 2a**: `p`'s sibling `s` is <span style="color:red">**red**</span>.  
    ...
    ![image](/assets/images/dsa/1123/case2a.png){:width="900px"}
  ...
  * **Case 2b**: `p`'s sibling `s` is **black** or **null**.  
    ...
    * i) Left Left Case (p is left child of g and x is left child of p)
    ![image](/assets/images/dsa/1123/case2b1.png){:width="900px"}
    * ii) Left Right Case (p is left child of g and x is right child of p)
    ![image](/assets/images/dsa/1123/case2b2.png){:width="900px"}
    * iii) Right Right Case (Mirror of case i)
    ![image](/assets/images/dsa/1123/case2b3.png){:width="900px"}
    * iv) Right Left Case (Mirror of case ii)
    ![image](/assets/images/dsa/1123/case2b4.png){:width="900px"}

### 3.3 Example of Insertion
![image](/assets/images/dsa/1123/example-insertion.png)
