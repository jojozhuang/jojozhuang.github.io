...
![image](/assets/images/java/1537/mysqlconnectordownload.png)  
...
![image](/assets/images/java/1537/selectall.png){:width="400px"}  
Now `Hibernate` User library is ready and we can add this User library to `HibernateTutorial` project build path.
![image](/assets/images/java/1537/userlibrarycreated.png){:width="700px"}  
Right click to project and click Build Path–>Configure Build Path
![image](/assets/images/java/1537/addbuildpath.png)
Then, click `Add Library`.
![image](/assets/images/java/1537/addlibrary.png){:width="700px"}
Select `User Library` and click Next button.
![image](/assets/images/java/1537/chooseuserlibrary.png){:width="600px"}
Finally, check the box of `Hibernate` User library and click Finish button.
![image](/assets/images/java/1537/finaladduserlibrary.png){:width="600px"}
After adding `Hibernate` User library to `HibernateTutorial` project, it will look like this:
![image](/assets/images/java/1537/structure2.png){:width="350px"}
...
$ docker images
```
![image](/assets/images/java/1537/dockerimage.png){:width="700px"}  
...
![image](/assets/images/java/1537/kitematic.png)  
...
![image](/assets/images/java/1537/newconnection.png){:width="800px"}
...
![image](/assets/images/java/1537/workbench.png)
...
![image](/assets/images/java/1537/finalstructure.png){:width="400px"}  
...
Name: Johnny Walker Salary: 10000.0
```
![image](/assets/images/java/1537/console.png)
...
```
![image](/assets/images/java/1537/datacreated.png)
