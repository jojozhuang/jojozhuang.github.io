...
## 1. Introduction
In the previous posting [Running JavaScript at Server Side with Rhino]({% link _popular/javapractice/running-javascript-at-server-side-with-rhino.md %}), we learned how to run javascript at server side. In this posting, we will learn how to call java classes and methods from javascript. We will re-use the servlet project from the previous posting, but it will be renamed to `RhinoWebsiteJava`.
...
![image](/public/images/java/1543/indexpage.png)
...
```
![image](/public/images/java/1543/gettime.png)
...
```
![image](/public/images/java/1543/instancemethod.png)
...
```
![image](/public/images/java/1543/staticmethod.png)
...
Hello johnny, greetings from CustomClass.greet().
```
![image](/public/images/java/1543/globalpackage.png)
...
Hello johnny, greetings from CustomClass.greet().
```
![image](/public/images/java/1543/withoutpackages.png)
