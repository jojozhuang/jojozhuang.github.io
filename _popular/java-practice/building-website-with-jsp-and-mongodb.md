...
### 1.2 MongoDB
MongoDB database has been installed. Otherwise, refer to [Installing MongoDB on Ubuntu and Mac]({% link _tutorial/dev-env/installing-mongodb-on-ubuntu-and-mac.md %}) to install MongoDB.
...
![image](/public/images/java/1533/converttomaven.png){:width="550px"}  
...
![image](/public/images/java/1533/project.png){:width="400px"}
...
![image](/public/images/java/1533/productlist.png)
Click the 'Create' button, input product name and price.
![image](/public/images/java/1533/productadd.png)
Click 'Save' button, product is saved.
![image](/public/images/java/1533/productlistafteradd.png)
Click 'Edit' button of the new added product. Change the product name and price.
![image](/public/images/java/1533/productedit.png)
Click 'Save' button, product(ID=4) is updated.
![image](/public/images/java/1533/productlistafteredit.png)
Click 'Delete' button of the last product. A popup window for confirming the delete operation shows up.
![image](/public/images/java/1533/deleteconfirm.png)
Click 'OK' button, product will be deleted.
![image](/public/images/java/1533/productlistafterdel.png)
