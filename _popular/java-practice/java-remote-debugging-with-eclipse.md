...
## 1. Introduction
In the posting [Using Java Debugger]({% link _popular/java-practice/using-java-debugger.md %}), we learned how to debug a Java application with Java debugger (JDB). In this posting, I will introduce how to debug the same Java application in Eclipse, which would be much easier and more convenient than using JDB.
...
![image](/public/images/java/1513/project.png)
...
![image](/public/images/java/1513/debugconfig.png){:width="800px"}
...
![image](/public/images/java/1513/rundebugmode.png){:width="600px"}

### 2.4 Debugging
In Eclipse, click the `Debug As..` button on toolbar and select `Sum Debugging`.
![image](/public/images/java/1513/attach.png)
You will see the debugging is working now. The first breakpoint is activated.
![image](/public/images/java/1513/debugperspective.png)
