...
Read tutorial [Generating Diagrams and Flowcharts with Mermaid]({% link _tutorial/legacy-blog/generating-diagrams-and-flowcharts-with-mermaid.md %}) to learn how to use Mermaid in web page.
