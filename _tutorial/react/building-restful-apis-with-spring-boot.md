...
![image](/public/tutorials/360/mavenproject.png){:width="650px"}  
In the new created project, there are two main branches, one is for source code, another is for test.
![image](/public/tutorials/360/initialproject.png){:width="350px"}  
...
![image](/public/tutorials/360/images_serving.png){:width="700px"}  

### 4.5 Final Project Structure
The final structure of the Web API project.
![image](/public/tutorials/360/project_final.png){:width="350px"}  
...
![image](/public/tutorials/360/getall.png)
...
![image](/public/tutorials/360/getone.png)
### 5.3 Add New Product
...
![image](/public/tutorials/360/add.png)
...
![image](/public/tutorials/360/addcheck.png)
### 5.4 Update Product
...
![image](/public/tutorials/360/upload.png)
...
![image](/public/tutorials/360/uploadcheck.png)
If you go to the project's image folder '/src/main/resources/images/', you will see this image.
![image](/public/tutorials/360/imageonserver.png){:width="700px"}  
