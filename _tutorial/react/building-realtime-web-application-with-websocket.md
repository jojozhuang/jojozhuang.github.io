...
![image](/public/tutorials/412/socketiotimer.png "Server Time")  
...
![image](/public/tutorials/412/socketiopaint1.png)  
After drawing is finished, switch to Firefox. Same drawing in Firefox.  
![image](/public/tutorials/412/socketiopaint2.png)  
Same in iPad.  
![image](/public/tutorials/412/socketiopaint3.png)  
Same in iPhone.  
![image](/public/tutorials/412/socketiopaint4.png)  
...
![image](/public/tutorials/412/mswebsocket1.png "MS WebSocket1"){:width="600px"}    
### 3.2 Second user comes in(another page), says 'I'm here, too'.  
![image](/public/tutorials/412/mswebsocket2.png "MS WebSocket2"){:width="600px"}    
### 3.3 Back to the page of first user.
![image](/public/tutorials/412/mswebsocket3.png "MS WebSocket3"){:width="600px"}    
...
![image](/public/tutorials/412/signalrsample.png "SignalR")  
