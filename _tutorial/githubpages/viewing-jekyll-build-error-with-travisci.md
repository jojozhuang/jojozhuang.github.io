...
One approach to figure out what is exactly happening with this issue is to setup Github Page website locally. I introduced the steps in blog [Setting up GitHub Pages Site Locally With Jekyll]({% link _tutorial/githubpages/setting-up-github-pages-site-locally-with-jekyll.md %}).
