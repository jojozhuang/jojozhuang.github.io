...
![image](/public/tutorials/602/appstore.png)  
...
![image](/public/tutorials/602/newproject1.png){:width="700px"}  
...
![image](/public/tutorials/602/newproject2.png){:width="700px"}  
...
![image](/public/tutorials/602/workspacewindow.png)

## 3. UI Design
1) In Xcode, click on `'Main.storyboard'`, add one view controller for 'New Product'.
![image](/public/tutorials/602/storyboardadd.png){:width="400px"}  
2) Add another view controller for 'Product List'.
![image](/public/tutorials/602/storyboardlist.png){:width="400px"}  
...
![image](/public/tutorials/602/connectbydragging.png)
![image](/public/tutorials/602/connectbydragging2.png)
4) In Xcode, File->New-File..., select 'Cocoa Touch Class' and click 'Next'.
![image](/public/tutorials/602/tableviewcontroller.png){:width="700px"}  
In the dialog that appears, use the following values, click 'Next'.
* Class: ProductTableViewController
* Subclass of: UITableViewController
* Language: Swift

![image](/public/tutorials/602/tableviewcontroller2.png){:width="700px"}  
...
![image](/public/tutorials/602/tableviewcell.png){:width="700px"}  
...
![image](/public/tutorials/602/productimages.png)

## 6. Testing
In Xcode, click the arrow button to run the app in simulator.
![image](/public/tutorials/602/simulator.png){:width="400px"}  
Product list.
![image](/public/tutorials/602/runproductlist.png){:width="350px"}  
Edit product.
![image](/public/tutorials/602/runproductadd.png){:width="350px"}  
Delete product.
![image](/public/tutorials/602/runproductdelete.png){:width="350px"}  
In landscape view.
![image](/public/tutorials/602/runlandscape.png){:width="700px"}  
