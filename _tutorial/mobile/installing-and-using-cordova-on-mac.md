...
![image](/public/tutorials/410/run_browser.png){:width="800px"}
### 3.2 iOS
...
![image](/public/tutorials/410/xcode_commandlinetools.png){:width="800px"}
...
```
![image](/public/tutorials/410/xcode_project.png)
In Xcode, click run button to start simulator.
![image](/public/tutorials/410/run_ios.png){:width="400px"}  
### 3.3 Android
...
cordova run android
```
![image](/public/tutorials/410/run_android.png){:width="400px"}  
