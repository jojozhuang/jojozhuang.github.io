...
![image](/assets/images/frontend/2334/project_stucture.png){:width="320px"}  
...
![image](/assets/images/frontend/2334/layout_productlist.png){:width="700px"}  
...
![image](/assets/images/frontend/2334/activity_productlist.png){:width="700px"}  
...
![image](/assets/images/frontend/2334/drawable_images.png){:width="320px"}  
### 1.7 Dummy Data
...
![image](/assets/images/frontend/2334/android_project.png){:width="320px"}  

## 5. Testing
In Visual Studio, click the arrow button(or Run->Start Without Debugging) to run the app in Android Emulator.
![image](/assets/images/frontend/2334/emulator.png){:width="400px"}  
Product list.
![image](/assets/images/frontend/2334/runproductlist.png){:width="350px"}  
Edit product.
![image](/assets/images/frontend/2334/runproductadd.png){:width="350px"}  
Select photo.
![image](/assets/images/frontend/2334/runphotochooser.png){:width="350px"}  
![image](/assets/images/frontend/2334/runphotochooser2.png){:width="350px"}  
Delete product.
![image](/assets/images/frontend/2334/runproductdelete.png){:width="350px"}  
In landscape view.
![image](/assets/images/frontend/2334/runlandscape.png){:width="700px"}  
