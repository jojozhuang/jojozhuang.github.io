...
![image](/public/tutorials/605/install_vs.png){:width="400px"}  
Accept the license, select the items, Install.
![image](/public/tutorials/605/install_components.png){:width="800px"}  
The installer starts the download and install process of the selected items.
![image](/public/tutorials/605/install_downloading.png){:width="800px"}  
...
![image](/public/tutorials/605/visualstudio_workspace.png)
...
![image](/public/tutorials/605/project_multiplatform.png){:width="800px"}  
You can also create native iOS project with C#.
![image](/public/tutorials/605/project_ios.png){:width="800px"}  
You can also create native Android project with C#.
![image](/public/tutorials/605/project_android.png){:width="800px"}  
Further more, you are also able to create ASP.NET applications.
![image](/public/tutorials/605/project_aspnet.png){:width="800px"}  
...
![image](/public/tutorials/605/newproject_native.png){:width="800px"}  
Give a name to your app and specify Organization Identifier, Next.
![image](/public/tutorials/605/newproject_appname.png){:width="800px"}  
Specify the location where the source files will locate, Create.
![image](/public/tutorials/605/newproject_location.png){:width="800px"}  
...
![image](/public/tutorials/605/newproject_finish.png)
...
![image](/public/tutorials/605/package_add.png){:width="800px"}  
...
![image](/public/tutorials/605/package_sqlite.png){:width="800px"}  
...
![image](/public/tutorials/605/package_config.png)
