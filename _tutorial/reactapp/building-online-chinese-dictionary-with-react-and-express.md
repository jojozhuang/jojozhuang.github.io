...
![image](/public/images/frontend/422/linebreak.png)

## 4. Webpack
For the configuration of Webpack, please refer to another blog [Creating Full Stack App with React and Node.js]({% link _tutorial/reactapp/creating-full-stack-app-with-react-and-nodejs.md %}).
