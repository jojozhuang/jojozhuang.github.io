...
![image](/public/tutorials/529/mysql_connector.png)  
...
![image](/public/tutorials/529/eclipse_project.png){:width="370px"}
Add Tomcat server to Eclipse. Go to Window->Show View->Server, click the link to add new server.
![image](/public/tutorials/529/eclipse_servers.png){:width="700px"}
Select Tomcat 9.0, next.
![image](/public/tutorials/529/eclipse_tomcat.png){:width="550px"}
Add our project to right side, finish.
![image](/public/tutorials/529/eclipse_addresource.png){:width="550px"}
In eclipse project, a new server folder for tomcat is added.
![image](/public/tutorials/529/eclipse_project2.png){:width="370px"}
Set Targeted Runtimes, go to Project->Properties->Targeted Runtimes, check Tomcat 9.0.
![image](/public/tutorials/529/eclipse_runtimes.png){:width="550px"}
...
![image](/public/tutorials/529/gamestore_launched.png)  
...
![image](/public/tutorials/529/docker_newimage.png){:width="700px"}  
...
![image](/public/tutorials/529/kitematic_mysql.png)
Port 3306 is also exposed and mapped to 6605.
![image](/public/tutorials/529/kitematic_port.png)

### 2.5 Connection URL
In Kitematic, select 'gsmysql' container, check the URL. It's `192.168.99.100:6605`.
![image](/public/tutorials/529/kitematic_url.png)  
...
![image](/public/tutorials/529/workbench_data.png)  
