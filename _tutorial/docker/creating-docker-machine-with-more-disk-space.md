...
```
![image](/public/tutorials/711/error.png)
...
![image](/public/tutorials/711/vmstorageold.png){:width="800px"}  
You can also check this size by selecting the `default` VM, then Settings -> Storage.
![image](/public/tutorials/711/vmstorageold2.png){:width="600px"}  
...
docker@default:~$ df -h
```
![image](/public/tutorials/711/diskspaceold.png){:width="700px"}  
### 2.3 Solution
...
$ docker-machine ls
```
![image](/public/tutorials/711/dockermachine.png){:width="700px"}  

Delete the docker machine named `default`.
```sh
$ docker-machine rm default
```
![image](/public/tutorials/711/deletedockermachine.png){:width="700px"}  
...
```
![image](/public/tutorials/711/resetip.png){:width="700px"}  
...
![image](/public/tutorials/711/newipaddress.png){:width="700px"}  
In Kitematic, same original IP.
![image](/public/tutorials/711/newipaddress2.png)  
