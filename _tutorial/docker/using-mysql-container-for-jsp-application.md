...
![image](/public/tutorials/603/sqlfile.png){:width="600px"}  
...
```
![image](/public/tutorials/603/restoredb.png){:width="600px"}  
...
![image](/public/tutorials/603/accessurl.png)  
...
![image](/public/tutorials/603/newconnection.png){:width="800px"}  
Store the password `jsppassword` for root to keychain.
![image](/public/tutorials/603/benchpassword.png){:width="400px"}  
Test Connection
![image](/public/tutorials/603/testconnection.png){:width="400px"}  
A new connection is added to the workbench.
![image](/public/tutorials/603/workbench.png)  
Check the original data. As you see, there are initially three rows in table Product.
![image](/public/tutorials/603/original.png)  
