...
![image](/public/tutorials/703/sqlfile.png){:width="600px"}  
...
```
![image](/public/tutorials/703/restoredb.png){:width="600px"}  
...
![image](/public/tutorials/703/accessurl.png)  
...
![image](/public/tutorials/703/newconnection.png){:width="800px"}  
Store the password `jsppassword` for root to keychain.
![image](/public/tutorials/703/benchpassword.png){:width="400px"}  
Test Connection
![image](/public/tutorials/703/testconnection.png){:width="400px"}  
A new connection is added to the workbench.
![image](/public/tutorials/703/workbench.png)  
Check the original data. As you see, there are initially three rows in table Product.
![image](/public/tutorials/703/original.png)  
