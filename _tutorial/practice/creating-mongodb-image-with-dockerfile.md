...
In Eclipse, open the MongoDB Tutorial project which we created for [Building Website with JSP and MongoDB]({% link _tutorial/practice/building-website-with-jsp-and-mongodb.md %}). Rename it to `MongoDBDockerfile`.
