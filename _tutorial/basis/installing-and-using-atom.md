...
![image](/public/tutorials/16/atom.png)  
...
![image](/public/tutorials/16/installplugin.png){:width="800px"}  
...
![image](/public/tutorials/16/compare.png)  
...
![image](/public/tutorials/16/minimap.png){:width="700px"}  
...
![image](/public/tutorials/16/tablekey.png){:width="600px"}  
2) Specify the number for rows and columns.  
![image](/public/tutorials/16/table64.png){:width="600px"}  
3) Table is inserted to document. You can now add content into it.  
![image](/public/tutorials/16/tablecreated.png){:width="600px"}  
4) Table shown in html page.  
![image](/public/tutorials/16/tablehtml.png){:width="600px"}  
...
![image](/public/tutorials/16/shortcut.png)  
...
![image](/public/tutorials/16/preview.png)  
