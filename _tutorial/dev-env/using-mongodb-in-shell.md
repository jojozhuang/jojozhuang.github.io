...
>
```
![image](/assets/images/devops/2133/create.png){:width="700px"}  
...
>
```
![image](/assets/images/devops/2133/update.png){:width="700px"}  
...
>
```
![image](/assets/images/devops/2133/delete.png){:width="700px"}  
...
```
![image](/assets/images/devops/2133/findand.png){:width="700px"}  
### 6.4 OR in MongoDB
Find products whose name is 'Xbox', or its price is greater than 600.
```raw
> db.product.find({$or:[{"name":"Xbox"},{"price":{$gt:600}}]})
```
![image](/assets/images/devops/2133/findor.png){:width="700px"}  
...
```
![image](/assets/images/devops/2133/findandor.png){:width="700px"}  
