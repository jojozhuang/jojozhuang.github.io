...
![image](/public/images/note/9134/executionprocess.png){:width="800px"}  
...
![image](/public/images/note/9134/helloworld.png){:width="500px"}  
...
![image](/public/images/note/9134/devserver.png){:width="500px"}
...
![image](/public/images/note/9134/devserver2.png){:width="500px"}  
...
![image](/public/images/note/9134/loadingstyles.png){:width="500px"}
Notice that the styles are added to the header. It is inline css.
![image](/public/images/note/9134/inlinestyle.png)  
**Loading Less**
```javascript
{
  test: /\.less$/,
...
![image](/public/images/note/9134/separatingcssmain.png){:width="800px"}
2) In the index.html, the css file is included in the header. Now, css is separated with html and javascript.
![image](/public/images/note/9134/separatingcsshtml.png){:width="800px"}
...
![image](/public/images/note/9134/loadingimages.png)
...
![image](/public/images/note/9134/base64.png){:width="800px"}
...
![image](/public/images/note/9134/loadingimages2.png)
...
![image](/public/images/note/9134/loadingfonts.png)
