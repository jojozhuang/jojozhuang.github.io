...
## 4. Intellij IDEA
Disable import * Intellij
```sh
Preferences > Editor > Code Style > Java > Imports > "Class count to use import with '*" and "Names count to use static import with '*'"
...
a) Go to /WORKSPACE/root/install/config/, open file RealmEnablement.table, copy and create a new realm
b) Then run ‘gnu addandinitrealms -add 1’
c) And run ‘gnu enablerealms’
