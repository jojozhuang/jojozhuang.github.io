...
image: /public/portfolio/courseplayerxamarin/thumbnail.png
...
![flash](/public/portfolio/courseplayerxamarin/flash.png)
...
![coliphone](/public/portfolio/courseplayerxamarin/coliphone.jpeg)
...
![image](/public/portfolio/courseplayerxamarin/homepage.png){:width="400px"}  
Click the `Play` button, the slider bar begins to move and the current time will increment in seconds. Meanwhile, the screenshot and whiteboard canvas show the content simultaneously.
![image](/public/portfolio/courseplayerxamarin/play.png){:width="400px"}  
You can drag the slider bar to move forward or backward.
![image](/public/portfolio/courseplayerxamarin/drag.png){:width="400px"}  

## 3. Under the Hood
Class diagram shows the design of this app based on Xamarin framework.
![framework](/public/portfolio/courseplayerxamarin/framework.png)  
