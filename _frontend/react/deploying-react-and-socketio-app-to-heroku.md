...
## 1. Socket.IO App
In the posting [Building Course Player with React and Socket.IO]({% link _frontend/react/building-course-player-with-react-and-socketio.md %}), I introduced how to build an course player with [React](https://reactjs.org/) and [Socket.IO](https://socket.io/). In this posting, I will introduce how to deploy this app to [Heroku](https://www.heroku.com/).
...
![image](/public/images/frontend/419/home.png)  
Click the 'Play' button and drag to slider bar.
![image](/public/images/frontend/419/play.png)  
