...
## 3. APIs for Testing
In the posting [Building RESTful API with ASP.NET Core]({% link _frontend/restful/building-restful-api-with-aspnet-core.md %}), I introduced how to create RESTful APIs with C#. Now, let's use Postman to test these APIs.
