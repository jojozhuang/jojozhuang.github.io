...
![image](/public/tutorials/161/structure.png){:width="400px"}  
...
![image](/public/tutorials/161/runonserver.png){:width="600px"}  
...
![image](/public/tutorials/161/products.png){:width="600px"}  
3) Get Product by ID  
* http://localhost:8080/JerseyTutorial/rest/ProductService/product/1

![image](/public/tutorials/161/oneproduct.png){:width="600px"}  
...
![image](/public/tutorials/161/jsonapi.png){:width="600px"}  
