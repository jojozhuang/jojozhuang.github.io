...
![image](/public/images/frontend/607/project_create.png){:width="800px"}  
Specify the name and Organization Identifier, Next.
![image](/public/images/frontend/607/project_appname.png){:width="800px"}  
Specify the location where the source files locate, Create.
![image](/public/images/frontend/607/project_location.png){:width="800px"}  
...
![image](/public/images/frontend/607/project_stucture.png){:width="320px"}  
...
![image](/public/images/frontend/607/package_add.png){:width="800px"}  
Search 'sqlite', select the package named 'sqlite-net-pcl', click 'Add Package'.
![image](/public/images/frontend/607/package_sqlite.png){:width="800px"}  
...
![image](/public/images/frontend/607/portable_project.png){:width="320px"}  
...
![image](/public/images/frontend/607/ios_tableviewcontroller.png){:width="700px"}  
...
![image](/public/images/frontend/607/ios_xcode.png)  
...
![image](/public/images/frontend/607/ios_storyboard.png)  
Connect the controls(label, textfield, button, etc) on canvas to code manually.
![image](/public/images/frontend/607/ios_connect.png)  
...
![image](/public/images/frontend/607/assets_images.png)  
### 3.9 Dummy Data
...
![image](/public/images/frontend/607/unwindtoexit.png)  
...
![image](/public/images/frontend/607/ios_project.png){:width="320px"}  

## 4. Testing
In Visual Studio, click the arrow button(or Run->Start Without Debugging) to run the app in iOS Simulator.
![image](/public/images/frontend/607/simulator.png){:width="400px"}  
Product list.
![image](/public/images/frontend/607/runproductlist.png){:width="350px"}  
Edit product.
![image](/public/images/frontend/607/runproductadd.png){:width="350px"}  
Select photo.
![image](/public/images/frontend/607/runimagepicker.png){:width="350px"}  
Delete product.
![image](/public/images/frontend/607/runproductdelete.png){:width="350px"}  
In landscape view.
![image](/public/images/frontend/607/runlandscape.png){:width="700px"}  
