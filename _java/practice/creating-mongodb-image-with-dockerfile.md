...
In Eclipse, open the MongoDB Tutorial project which we created for [Building Website with JSP and MongoDB]({% link _java/practice/building-website-with-jsp-and-mongodb.md %}). Rename it to `MongoDBDockerfile`.
