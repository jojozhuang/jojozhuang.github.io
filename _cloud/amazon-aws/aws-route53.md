...
![image](/assets/images/cloud/4108/freenom_domain.png)
...
![image](/assets/images/cloud/4108/domain-blank-page.png)
...
![image](/assets/images/cloud/4108/three-ec2-instances.png)
...
![image](/assets/images/cloud/4108/create-hosted-zones-1.png)
...
```
![image](/assets/images/cloud/4108/create-hosted-zones-2.png)
...
![image](/assets/images/cloud/4108/change-name-server.png)
...
![image](/assets/images/cloud/4108/create-hosted-zones-3.png)
Click "Define simple record".
![image](/assets/images/cloud/4108/create-hosted-zones-4.png)
...
![image](/assets/images/cloud/4108/create-hosted-zones-5.png)
The record is added, click "Create records".
![image](/assets/images/cloud/4108/create-hosted-zones-6.png)
In the domain's home page, we see the new A record with the values of three ip addresses.
![image](/assets/images/cloud/4108/create-hosted-zones-7.png)
Now you are able to access the web server in your EC2 instance with the domain myaws.ga.
![image](/assets/images/cloud/4108/create-hosted-zones-8.png)
...
![image](/assets/images/cloud/4108/create-hosted-zones-9.png)
Wait for 60 seconds and refresh the page. The content is returned from California server.
![image](/assets/images/cloud/4108/create-hosted-zones-10.png)
...
![image](/assets/images/cloud/4108/define-weighted-record.png)
...
![image](/assets/images/cloud/4108/6-5-weighted-routing-policy-5.png)
...
Set TTL to 1 minute, click "Create records".
![image](/assets/images/cloud/4108/6-6-latency-routing-policy-5.png)
We will see three new A records with latency routing policy.
![image](/assets/images/cloud/4108/6-6-latency-routing-policy-6.png)
...
![image](/assets/images/cloud/4108/6-7-failover-routing-policy-7.png)
Set TTL to 1 minute, click "Create records".
![image](/assets/images/cloud/4108/6-7-failover-routing-policy-8.png)
We will see two new A records with failover routing policy.
![image](/assets/images/cloud/4108/6-7-failover-routing-policy-9.png)
...
Set TTL to 1 minute, click "Create records".
![image](/assets/images/cloud/4108/6-8-geolocation-routing-policy-5.png)
We will see two new A records with geolocation routing policy.
![image](/assets/images/cloud/4108/6-8-geolocation-routing-policy-6.png)
Access the domain, it should return the Oregon page.
![image](/assets/images/cloud/4108/6-7-failover-routing-policy-10.png)
...
![image](/assets/images/cloud/4108/multivalue-routing-policy.png)
