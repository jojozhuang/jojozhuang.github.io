...
![rundebugmode](/public/posts/2016-03-21/rundebugmode.png){:width="600px"}
...
jdb -attach 4000
```
![attachport](/public/posts/2016-03-21/attachport.png){:width="600px"}
...
main[1] list
```
![step](/public/posts/2016-03-21/step.png){:width="600px"}
...
![print](/public/posts/2016-03-21/print.png){:width="600px"}
Step one more time, and use `locals` command to see all local variables.
![locals](/public/posts/2016-03-21/locals.png){:width="600px"}
...
![cont](/public/posts/2016-03-21/cont.png){:width="600px"}
Switch to the first terminal, you see the result is printed out and debug process is stopped as well.
![return](/public/posts/2016-03-21/return.png){:width="600px"}
