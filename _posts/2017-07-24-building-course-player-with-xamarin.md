...
layout: post
key: blog
title: "Building Course Player with Xamarin(Draft)"
date: 2017-07-24
tags: [Xamarin, C#]
---
...
![MIME Type](/public/pics/2017-07-21/project_create.png){:width="800px"}  
Specify the name and Organization Identifier, Next.
![MIME Type](/public/pics/2017-07-21/project_appname.png){:width="800px"}  
Specify the location where the source files locate, Create.
![MIME Type](/public/pics/2017-07-21/project_location.png){:width="800px"}  
...
![MIME Type](/public/pics/2017-07-21/project_stucture.png){:width="320px"}  
...
![MIME Type](/public/pics/2017-07-21/package_add.png){:width="800px"}  
Search 'sqlite', select the package named 'sqlite-net-pcl', click 'Add Package'.
![MIME Type](/public/pics/2017-07-21/package_sqlite.png){:width="800px"}  
...
![MIME Type](/public/pics/2017-07-21/ios_tableviewcontroller.png){:width="700px"}  
...
![MIME Type](/public/pics/2017-07-21/ios_xcode.png)  
...
![MIME Type](/public/pics/2017-07-21/ios_storyboard.png)  
Connect the controls(label, textfield, button, etc) on canvas to code manually.
![MIME Type](/public/pics/2017-07-21/ios_connect.png)  
...
![MIME Type](/public/pics/2017-07-21/assets_images.png)  
### 3.9 Dummy Data
...
![MIME Type](/public/pics/2017-07-21/unwindtoexit.png)  
