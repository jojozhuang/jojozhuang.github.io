...
![image](/public/posts/2018-01-06/middleware.png){:width="800px"}  
...
![image](/public/posts/2018-01-06/authenticationfail.png){:width="600px"}
Now, let's try to access http://localhost:3000/hello/johnny. You passed the authentication check this time.
![image](/public/posts/2018-01-06/authenticationpass.png){:width="600px"}  
...
![image](/public/posts/2018-01-06/filenotfound.png){:width="600px"}
But if you try access http://localhost:3000/index.html, you will get the page properly.
![image](/public/posts/2018-01-06/statichtml.png){:width="600px"}  
