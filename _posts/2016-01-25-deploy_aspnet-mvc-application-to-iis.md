...
> This blog guides you how to deploy your ASP.NET/MVC application to IIS web server. And make it public to internet. There are totally 4 steps:
...
2.  **Publish files to IIS**
    ...
    1.  In Visual Studio, select project - &gt; Publish…
    ...
    3.  Connection, configure server and website. Here we choose the default website.

        <img src="/public/pics/2016-01-25/image5.png" width="415" height="328" />

    4.  Settings, choose ‘Release’.

        <img src="/public/pics/2016-01-25/image6.png" width="415" height="328" />

    5.  Preview, check what files are to be deployed.

        <img src="/public/pics/2016-01-25/image7.png" width="425" height="336" />

    6.  After publish, all of files are copied to ‘C:\\inetpub\\wwwroot\\CoursePlayer’.
...
4.  **Assign Public IP address to your website.**
    ...
    1.  In IIS, add Binding to web site
    ...
    3.  Access website with ip address, don’t miss the last slash.

        <http://140.192.34.30/courseplayer>

        <img src="/public/pics/2016-01-25/image19.png" width="494" height="357" />

    4.  Try this address in another machine.
