...
We learned how to build RESTful API from [Building RESTful APIs with Express And MongoDB]({% link _posts/2018-01-16-building-restful-apis-with-nodejs-and-mongodb.md %}), and we also learned how to build web application with Angular from [Building CRUD Application With Angular]({% link _posts/2018-01-17-building-crud-application-with-angular.md %}). In this tutorial, I will reuse the `Angular project` and merge the `Express project` into it to setup the MEAN stack project.
...
![image](/public/posts/2018-01-18/merge.png){:width="350px"}
...
![image](/public/posts/2018-01-18/start.png)

Open web browser, access 'http://localhost:12080/'.
![image](/public/posts/2018-01-18/homepage.png)
Access the product list page.
![image](/public/posts/2018-01-18/productlist.png)
Through the debug tool, we can see, the name is fetched from the api.
![image](/public/posts/2018-01-18/api.png)
...
![image](/public/posts/2018-01-18/logs.png){:width="350px"}
